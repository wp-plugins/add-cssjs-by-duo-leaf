...
* Code highlight
* Auto minify files
* Use files as external
* Use regex to filter which pages the script will be injected
...
1. List of Javascript and CSS located in 'Settings > Add CSS/Js by Duo Leaf'
2. Form to add your Javascript or CSS
